...
how the encryption/decryption works when reading the console. Do not include '/' at the end. Also note that the browsers cache can mess with the functionality
